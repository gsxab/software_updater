...
require (
	...
	github.com/gsxab/go-error_util v0.1.0
	github.com/gsxab/go-generic_lru v1.0.4
	github.com/gsxab/go-logs v1.0.0
	github.com/gsxab/go-optional v0.2.0
	github.com/gsxab/go-slice_util v0.2.0
...
require (
	...
	github.com/mediabuyerbot/go-crx3 v1.4.1 // indirect
